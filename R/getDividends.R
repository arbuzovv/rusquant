...
"getDividends" <- function(from=Sys.Date()-10,to=Sys.Date(),country='')
  {
    ...
    print('Fetching data from investing.com. Please wait... You can forces process using change date interval to smaller or change less than 5 countries')
